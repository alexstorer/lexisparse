...
What's nice to have:
 1) Extract title
 2) Add file name to log, for backtracking of issues
 3) Extract all meta columns (maybe in R) using fill in bind
"""
# import os
# os.chdir('/Users/steffennauhaus/Documents/Projects/Sentiment-Data/Testing')
# f = "All_English_Language_News2016-02-02_12-05.TXT"
# fp = open(f,'rU')
# fullstr = fp.read()
# 
